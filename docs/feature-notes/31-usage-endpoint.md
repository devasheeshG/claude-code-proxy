...
This note documents the usage endpoint behavior in the Claude Code Proxy. It is intentionally small so operators and contributors can find one decision without searching the entire README.
