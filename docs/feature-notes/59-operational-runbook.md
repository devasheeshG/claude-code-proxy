...
This note documents the operational runbook behavior in the Claude Code Proxy. It is intentionally small so operators and contributors can find one decision without searching the entire README.
